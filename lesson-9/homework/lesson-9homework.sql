...
select p.ProductName, o.OrderID from Orders as o
join Products as p
...
select O.OrderID, p.PaymentID, p.Amount from Orders as o
join Payments as p
...
select c.FirstName, s.productid, s.saleamount from sales as s 
join Customers as c
on c.CustomerID = s.Customerid
where s.saleamount > 500

select s.Name, c.coursename from Enrollments as en
join Students as s
...
select O.OrderID, p.Amount as payment_amount, o.TotalAmount from  Orders as o
join Payments as p 
on o.OrderID = p.OrderID
...
select s.SaleID, c.CustomerID, c.FirstName, c.Country, s.SaleAmount 
from Customers as c
join Sales as s
...
select e1.Name AS Employee1, e2.Name AS Employee2 from Employees as e1
...
e2.Salary as managersal, e1.Salary as employeesalary 
