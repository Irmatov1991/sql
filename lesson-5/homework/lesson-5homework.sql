...
SELECT ProductName AS Name, Price
FROM Products;
...
SELECT Client.CustomerID, Client.FirstName, Client.City
...
SELECT EmployeeID, FirstName, LastName, Age, Salary, DepartmentName
FROM Employees
...
--tasks Insert 40 rows into Orders with random dates and years
