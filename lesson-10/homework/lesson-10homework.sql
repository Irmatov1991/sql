...
on e.DepartmentID = d.DepartmentID and e.Salary > 50000
...
--7--
select e1.Name, e2.Name as managername from Employees as e1
...
--8--
select st.Name, c.CourseName from students as st
...
--11--
select d1.DepartmentName, COUNT(e1.employeeid) as emp_count from Employees as e1
join Departments as d1
on e1.DepartmentID = d1.DepartmentID
group by d1.DepartmentName
having COUNT(e1.employeeid) > 5
...
--12--
select p1.ProductID, p1.ProductName from Products as p1
...
select c.FirstName, c.LastName, count(OrderID) as total_orders from Customers as c
join Orders as o
on c.CustomerID = o.CustomerID
...
select e1.Name, d1.DepartmentName from Employees as e1
left join Departments as d1
on e1.DepartmentID = d1.DepartmentID
where d1.DepartmentName is not null
...
--14--
select e1.Name as employees1, e2.Name as employees2, e1.ManagerID from Employees as e1
...
--15--
select o1.OrderID, o1.OrderDate, c1.FirstName, c1.LastName from Orders as o1
join  Customers as c1
on c1.CustomerID = o1.CustomerID
where YEAR(o1.OrderDate) = 2022

--16--
select e1.Name, d1.DepartmentName, e1.Salary from Employees as e1
join Departments as d1
on e1.DepartmentID = d1.DepartmentID
where  d1.DepartmentName = 'Sales'
and e1.Salary > 60000

--17--
select p1.OrderID, o1.OrderDate, p1.PaymentDate, p1.Amount  from Orders as o1
join Payments as p1
on o1.OrderID = p1.OrderID


select p1.OrderID, o1.OrderDate, p1.PaymentDate, p1.Amount  from Orders as o1
left join Payments as p1
on o1.OrderID = p1.OrderID
where p1.Amount is not null


--18--
select o1.ProductID, p1.ProductName from Products as p1
left join Orders as o1
on p1.ProductID= o1.ProductID
where o1.ProductID is null

--19--

select e1.Name,e1.Salary from Employees as e1
join (select departmentid, AVG(salary) as avg_sal
from Employees 
group by departmentid) as avg_salar
on e1.DepartmentID = avg_salar.DepartmentID
where e1.Salary > avg_salar.avg_sal

--20--
select o1.OrderID, o1.OrderDate from Orders as o1
left join Payments as p1
on o1.OrderID = p1.OrderID
where p1.OrderID is null and 
o1.OrderDate < '2020-01-01'
...
select p1.ProductID, p1.ProductName, p1.Category from Products as p1
left join Categories as c1
on p1.Category = c1.CategoryID
where c1.CategoryID is null

select e1.Name as employee1, e2.Name as employee2,
e1.ManagerID, e1.Salary from Employees as e1
join Employees as e2
...
join Departments as d1
on e1.DepartmentID = d1.DepartmentID
where e1.Name like 'M%'


--24--
select s1.SaleID, p1.ProductName, s1.SaleAmount from Products as p1
join Sales as s1
on p1.ProductID = s1.ProductID
...
--25--
select s1.SaleID, p1.ProductName, s1.SaleAmount from  Sales as s1
join Products as p1
on p1.ProductID = s1.ProductID
where s1.SaleAmount > 500
...
select st.StudentID, st.Name from Students as st
where st.StudentID not in(
select e1.studentid from Enrollments as e1
join courses as c1
...
select st.StudentID, st.Name from students as st
where not Exists(
select 1 from Enrollments as e1
join Courses as c1
on c1.CourseID = e1.CourseID
where c1.CourseName = 'Math 101'
and st.StudentID = e1.StudentID)

select st.StudentID, st.Name from Students as st
left join Enrollments as e1
on st.StudentID = e1.StudentID
left join Courses as c1
on e1.CourseID = c1.CourseID
and c1.CourseName = 'Math 101'
